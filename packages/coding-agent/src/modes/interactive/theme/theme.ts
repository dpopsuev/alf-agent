...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@alef/tui";
...
const THEME_KEY = Symbol.for("@alef/coding-agent:theme");
...
export function getSettingsListTheme(): import("@alef/tui").SettingsListTheme {
	return {
